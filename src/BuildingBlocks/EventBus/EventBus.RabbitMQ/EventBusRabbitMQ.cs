    ...
    public class EventBusRabbitMQ : BaseEventBus
    {
        ...
        public EventBusRabbitMQ(EventBusConfig config, IServiceProvider serviceProvider ) : base(config, serviceProvider)
        {
            if (config.Connection != null)
            {
                ...
                {
                    //self referencing loop detected for proporty
            ...
            SubsManager.OnEventRemoved += SubsManager_OnEventRemove;
        }
        ...
        private void SubsManager_OnEventRemove(object sender, string eventName)
        {
            ...
            //using var channel = persistenConnecton.CreateModel();
